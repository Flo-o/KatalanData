...
if catalan_names:
    ...
    #print(sorted(list(catalan_names))
else:
    print("Fehler")
...
def get_weighted_castilian_core(configs):
    ...
    print(f"Gewichteter Kern extrahiert: {len(combined_set)} Namen.")
    return combined_set
...
plot_percentage_heatmap(df_percent_stats, "Katalan_Boom_Prozent_1970_compl.png")
print("Beispiele für Namen in der sauberen Liste:")
print(clean_list[:50])
df_sorted = df_percent_stats.sort_values(by='Quote', ascending=False)

print("\n" + "="*40)
print("RANKING: ANTEIL KATALANISCHER NAMEN (1980)")
print("="*40)
...
check_files("C:/Machine/GanzSpanien70", provinzen, "70")
